...
analyser.analyze_gen_variable("Número de nodos", range_n, simulatorGeneratorArgs, kwargs, 100,  title="Extrema Propagation Timeout Single Start K=100 Drop=20%", results_name="T")
