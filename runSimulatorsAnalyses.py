...
def analize_n():
    ...
    analyser.analyze_gen_variable("Número de nodos", range_n, ExtAllNeigh.simulatorGeneratorArgs, kwargs, n_iters,
                                  title="Extrema Propagation All Neighbors K=128 T=25  Drop=0%", results_name="Erro relativo (%)")
    # No TArgs
    print("No Wait N, no network change")
    analyser.analyze_gen_variable("Número de nodos", range_n, ExtAllNeighNoWait.simulatorGeneratorArgs, kwargs, n_iters,
                                  title="Extrema Propagation No Wait K=128 T=25 Drop=0%", results_name="Erro relativo (%)")
    print("No Wait Change N, no network change")
    analyser.analyze_gen_variable("Número de nodos", range_n, ExtAllNeighNoWaitChange.simulatorGeneratorArgs, kwargs, n_iters,
                                  title="Extrema Propagation No Wait with Change K=128 T=25 Drop=0%", results_name="Erro relativo (%)")
